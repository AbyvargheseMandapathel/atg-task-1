    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address_pincode', models.CharField(blank=True, max_length=20, null=True)),
                ('user_type', models.CharField(blank=True, choices=[('P', 'Patient'), ('D', 'Doctor')], max_length=1, null=True)),
